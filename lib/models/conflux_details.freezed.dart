...
mixin _$ConfluxDetails {
 ...
 String get id; DateTime get created_at; DateTime get last_seen; String get user_id; String? get tag; String? get signature; String? get cidr; String get subnet; String get realm; String get realm_id; bool get public; bool get portal; String get region; String get veil_host; int get veil_port;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,created_at,last_seen,user_id,tag,signature,cidr,subnet,realm,realm_id,public,portal,region,veil_host,veil_port);

@override
String toString() {
  return 'ConfluxDetails(id: $id, created_at: $created_at, last_seen: $last_seen, user_id: $user_id, tag: $tag, signature: $signature, cidr: $cidr, subnet: $subnet, realm: $realm, realm_id: $realm_id, public: $public, portal: $portal, region: $region, veil_host: $veil_host, veil_port: $veil_port)';
}
...
@useResult
$Res call({
 String id, DateTime created_at, DateTime last_seen, String user_id, String? tag, String? signature, String? cidr, String subnet, String realm, String realm_id, bool public, bool portal, String region, String veil_host, int veil_port
});
...
/// Create a copy of ConfluxDetails
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? created_at = null,Object? last_seen = null,Object? user_id = null,Object? tag = freezed,Object? signature = freezed,Object? cidr = freezed,Object? subnet = null,Object? realm = null,Object? realm_id = null,Object? public = null,Object? portal = null,Object? region = null,Object? veil_host = null,Object? veil_port = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime created_at,  DateTime last_seen,  String user_id,  String? tag,  String? signature,  String? cidr,  String subnet,  String realm,  String realm_id,  bool public,  bool portal,  String region,  String veil_host,  int veil_port)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ConfluxDetails() when $default != null:
return $default(_that.id,_that.created_at,_that.last_seen,_that.user_id,_that.tag,_that.signature,_that.cidr,_that.subnet,_that.realm,_that.realm_id,_that.public,_that.portal,_that.region,_that.veil_host,_that.veil_port);case _:
  return orElse();
...
class _ConfluxDetails implements ConfluxDetails {
   _ConfluxDetails({required this.id, required this.created_at, required this.last_seen, required this.user_id, this.tag, this.signature, this.cidr, required this.subnet, required this.realm, required this.realm_id, required this.public, required this.portal, required this.region, required this.veil_host, required this.veil_port});
...
/// Create a copy of ConfluxDetails
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? created_at = null,Object? last_seen = null,Object? user_id = null,Object? tag = freezed,Object? signature = freezed,Object? cidr = freezed,Object? subnet = null,Object? realm = null,Object? realm_id = null,Object? public = null,Object? portal = null,Object? region = null,Object? veil_host = null,Object? veil_port = null,}) {
