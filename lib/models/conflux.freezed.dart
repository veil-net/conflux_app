...
mixin _$Conflux {
 ...
 String get id; DateTime get created_at; String get user_id; String get realm_id; String? get tag; bool get portal;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,created_at,user_id,realm_id,tag,portal);

@override
String toString() {
  return 'Conflux(id: $id, created_at: $created_at, user_id: $user_id, realm_id: $realm_id, tag: $tag, portal: $portal)';
}
...
@useResult
$Res call({
 String id, DateTime created_at, String user_id, String realm_id, String? tag, bool portal
});
...
/// Create a copy of Conflux
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? created_at = null,Object? user_id = null,Object? realm_id = null,Object? tag = freezed,Object? portal = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime created_at,  String user_id,  String realm_id,  String? tag,  bool portal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Conflux() when $default != null:
return $default(_that.id,_that.created_at,_that.user_id,_that.realm_id,_that.tag,_that.portal);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime created_at,  String user_id,  String realm_id,  String? tag,  bool portal)  $default,) {final _that = this;
switch (_that) {
case _Conflux():
return $default(_that.id,_that.created_at,_that.user_id,_that.realm_id,_that.tag,_that.portal);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime created_at,  String user_id,  String realm_id,  String? tag,  bool portal)?  $default,) {final _that = this;
switch (_that) {
case _Conflux() when $default != null:
return $default(_that.id,_that.created_at,_that.user_id,_that.realm_id,_that.tag,_that.portal);case _:
  return null;
...
class _Conflux implements Conflux {
   _Conflux({required this.id, required this.created_at, required this.user_id, required this.realm_id, this.tag, required this.portal});
...
/// Create a copy of Conflux
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? created_at = null,Object? user_id = null,Object? realm_id = null,Object? tag = freezed,Object? portal = null,}) {
