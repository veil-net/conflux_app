...
@riverpod
class PrimaryParticles extends _$PrimaryParticles {
  ...
  List<Particle> build(int count) {
    ...
    return List.generate(
      ...
      (_) => Particle(
        ...
        radius_x: _random.nextDouble(),
        radius_y: _random.nextDouble(),
...
@riverpod
class SecondaryParticles extends _$SecondaryParticles {
  final _random = Random();
